...
---
## 소개
시각적으로 매력적인 프레젠테이션 슬라이드를 만들려면 연결선을 정밀하게 조정해야 하는 경우가 많습니다. 이 튜토리얼에서는 Aspose.Slides for .NET을 사용하여 프레젠테이션 슬라이드에서 연결선 각도를 조정하는 방법을 살펴보겠습니다. Aspose.Slides는 개발자가 프로그래밍 방식으로 PowerPoint 파일을 작업할 수 있도록 하는 강력한 라이브러리로, 프레젠테이션을 생성, 수정 및 조작하기 위한 광범위한 기능을 제공합니다.
## 전제조건
