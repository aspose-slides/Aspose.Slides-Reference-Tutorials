...
## Шаг 2. Загрузите презентацию
 ...
 Для начала вам нужно загрузить презентацию, которую вы хотите преобразовать в HTML. Заменять`"Your Document Directory"` с фактическим каталогом, в котором находится файл вашей презентации.
...
### 3. Есть ли какие-либо ограничения на встраивание шрифтов в HTML с помощью Aspose.Slides для .NET?
