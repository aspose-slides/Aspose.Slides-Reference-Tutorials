...
## Идентификация и включение скрытых слайдов

Aspose.Slides предоставляет возможность идентифицировать скрытые слайды в презентации и включать их во время преобразования. Этого можно добиться, перебирая слайды и проверяя их свойства видимости:
...
foreach (var slide in presentation.Slides)
{
    ...
    {
        // Включить скрытый слайд в логику преобразования
    }
    else
    {
        // Включить видимый слайд в логику преобразования
    }
}
```
