...
1. Получить время слайда: определите время слайда, в котором вы хотите, чтобы звук начал воспроизводиться. Это имеет решающее значение для плавной синхронизации.
