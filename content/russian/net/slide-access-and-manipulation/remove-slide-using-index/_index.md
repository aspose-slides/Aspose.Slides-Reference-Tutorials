...
description: Узнайте, как шаг за шагом стереть слайды PowerPoint с помощью Aspose.Slides для .NET. Наше руководство содержит четкие инструкции и полный исходный код, которые помогут вам программно удалять слайды по их последовательному индексу.
type: docs
weight: 24
