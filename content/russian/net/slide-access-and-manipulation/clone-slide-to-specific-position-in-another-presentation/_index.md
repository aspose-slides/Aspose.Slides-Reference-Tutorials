...
Да, Aspose.Slides позволяет вам программно манипулировать содержимым слайдов, включая текст, изображения, фигуры и многое другое, предоставляя вам полный контроль над вашими презентациями.
