...
Инициализируйте свой проект и укажите пути к файлам ваших документов, включая выходной файл презентации и изображение, которое будет использоваться для эффекта масштабирования.
```csharp
