...
description: Узнайте, как настроить верхний и нижний колонтитулы в слайдах заметок с помощью Aspose.Slides для .NET. В этом пошаговом руководстве представлены примеры исходного кода, а также описаны доступ к элементам, их изменение и стилизация.
type: docs
weight: 11
