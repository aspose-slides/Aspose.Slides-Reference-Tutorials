...
Да, Aspose.Slides для .NET позволяет анимировать различные элементы PowerPoint, включая фигуры, текст, изображения и диаграммы, как показано в этом руководстве.
