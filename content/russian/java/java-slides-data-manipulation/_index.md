...
### [Инвертировать, если отрицательное значение для отдельных серий в слайдах Java](./invert-if-negative-individual-series-java-slides/)
...
Узнайте, как настроить внешние книги и обновить данные диаграммы в Java Slides с помощью Aspose.Slides для Java. Совершенствуйте свои навыки автоматизации PowerPoint.
