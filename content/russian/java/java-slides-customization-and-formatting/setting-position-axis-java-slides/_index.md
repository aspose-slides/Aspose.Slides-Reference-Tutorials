...
В этом уроке мы узнаем, как установить ось положения на диаграмме с помощью Aspose.Slides для Java. Расположение оси может оказаться полезным, если вы хотите настроить внешний вид и макет диаграммы. Мы создадим кластеризованную столбчатую диаграмму и отрегулируем положение горизонтальной оси между категориями.
