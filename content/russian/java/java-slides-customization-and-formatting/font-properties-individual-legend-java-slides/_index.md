...
Теперь давайте настроим свойства шрифта для отдельной записи легенды на диаграмме. В этом примере мы нацелены на вторую запись легенды (индекс 1), но вы можете настроить индекс в соответствии с вашими конкретными требованиями.
