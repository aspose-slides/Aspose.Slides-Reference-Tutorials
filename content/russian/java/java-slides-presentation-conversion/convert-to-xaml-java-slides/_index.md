...
XAML (расширяемый язык разметки приложений) — это язык разметки, используемый для создания пользовательских интерфейсов в приложениях, особенно в тех, которые созданы с использованием таких технологий, как WPF (Windows Presentation Foundation) и UWP (универсальная платформа Windows).
