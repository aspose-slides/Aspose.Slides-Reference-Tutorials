...
2. Создайте проект Java. Настройте проект Java в вашей любимой IDE и убедитесь, что у вас есть папка «lib», в которую вы можете поместить JAR-файл Aspose.Slides.
