...
-  Aspose.Slides for .NET：确保您已将 Aspose.Slides 库集成到您的 .NET 项目中。如果没有，请从[发布页面](https://releases.aspose.com/slides/net/).
...
答：是的，你可以从[这里](https://purchase.aspose.com/temporary-license/)进行测试和评估。
