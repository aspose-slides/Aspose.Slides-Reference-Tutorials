...
4.  Προσωρινή Άδεια: Λάβετε μια δωρεάν προσωρινή άδεια από[Σελίδα προσωρινής άδειας του Aspose](https://purchase.aspose.com/temporary-license/) για να ξεκλειδώσετε την πλήρη λειτουργικότητα του Aspose.Slides για Java.
## Εισαγωγή πακέτων
