...
Μπορείτε να προσαρμόσετε τον κώδικα για να χειριστείτε διαφορετικές μορφές εξωτερικών βιβλίων εργασίας χρησιμοποιώντας τις κατάλληλες κλάσεις και μεθόδους Aspose.Cells για ανάγνωση και εγγραφή δεδομένων σε αυτήν τη μορφή.
