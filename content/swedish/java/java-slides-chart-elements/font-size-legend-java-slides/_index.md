...
```
 ...
 den här koden skapar vi ett klustrade kolumndiagram på den första bilden och ställer in teckenstorleken på förklaringstexten till 20 punkter. Du kan justera`setFontHeight` värde för att ändra teckenstorleken efter behov.
