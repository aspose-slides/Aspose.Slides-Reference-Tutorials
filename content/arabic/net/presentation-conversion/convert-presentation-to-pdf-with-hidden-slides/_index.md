...
## تحديد الشرائح المخفية وإدراجها

يوفر Aspose.Slides طريقة لتحديد الشرائح المخفية داخل العرض التقديمي وإدراجها أثناء التحويل. يمكن تحقيق ذلك من خلال التكرار عبر الشرائح والتحقق من خصائص رؤيتها:
...
foreach (var slide in presentation.Slides)
{
    ...
    {
        // تضمين الشريحة المخفية في منطق التحويل
    }
    else
    {
        // قم بتضمين شريحة مرئية في منطق التحويل
    }
}
```
