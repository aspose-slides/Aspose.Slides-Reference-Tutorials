...
يعمل Aspose.Slides for .NET على تبسيط عملية العمل مع عروض PowerPoint التقديمية برمجياً. في هذا الدليل، قمنا بتغطية خطوات استبدال عنوان الصورة لإطار كائن OLE في شرائح العرض التقديمي. باتباع هذه الخطوات، يمكنك التعامل مع العروض التقديمية بكفاءة وفقًا لمتطلباتك.
