...
الآن بعد أن أصبح عرضنا التقديمي جاهزًا، فلنضيف نموذجًا ثلاثي الأبعاد إلى الشريحة. يمكنك الاختيار من بين مجموعة متنوعة من التنسيقات مثل OBJ أو STL أو FBX. إليك كيفية إضافة نموذج ثلاثي الأبعاد إلى الشريحة:
