...
### [الرؤوس والخطوط المخصصة في العروض التقديمية](./custom-headers-and-fonts-in-presentations/)
تعرف على كيفية تخصيص الرؤوس والخطوط في العروض التقديمية باستخدام Aspose.Slides لـ .NET. دليل خطوة بخطوة مع أمثلة التعليمات البرمجية. تعزيز الجاذبية البصرية والعلامة التجارية دون عناء.
...
### [تنسيق أشكال SVG في العروض التقديمية](./formatting-svg-shapes-in-presentations/)
تعرف على كيفية تنسيق أشكال SVG في العروض التقديمية باستخدام Aspose.Slides لـ .NET. دليل خطوة بخطوة مع كود المصدر. ارتقِ بتصميم العرض التقديمي الخاص بك اليوم!
...
تعرف على كيفية تصدير الأشكال من عرض PowerPoint التقديمي إلى تنسيق SVG باستخدام Aspose.Slides لـ .NET. دليل خطوة بخطوة مع كود المصدر متضمن. استخراج الأشكال بكفاءة لمختلف التطبيقات.
...
### [ربط كافة الخطوط في وحدة تحكم HTML](./link-all-fonts-in-html-controller/)
تعرف على كيفية ربط جميع الخطوط في وحدة تحكم HTML باستخدام Aspose.Slides لـ .NET. سيساعدك هذا الدليل خطوة بخطوة المزود بكود المصدر على ضمان عرض الخطوط بشكل متسق في عروضك التقديمية. 
