...
### الخطوة 3: إضافة الأقسام
 ...
 نقوم بعد ذلك بإضافة أقسام إلى العرض التقديمي باستخدام ملف`AddSection` و`AppendEmptySection` طُرق. في هذا المثال، تتم إضافة "القسم 1" إلى الشريحة الأولى، ويتم إلحاق "القسم 2".
