...
description: تعرف على كيفية التحكم في أنواع الرسوم المتحركة في شرائح PowerPoint باستخدام Aspose.Slides لـ .NET. يوفر هذا الدليل خطوة بخطوة أمثلة على التعليمات البرمجية المصدر ويغطي التثبيت وتنفيذ التعليمات البرمجية وتعديل تأثيرات الرسوم المتحركة.
type: docs
weight: 11
