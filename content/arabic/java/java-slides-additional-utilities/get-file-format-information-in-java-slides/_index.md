...
إذا أعاد الرمز "تنسيق العرض التقديمي غير معروف"، فهذا يعني أن تنسيق ملف العرض التقديمي لم يتم التعرف عليه أو دعمه بواسطة Aspose.Slides لـ Java. تأكد من أنك تستخدم تنسيقًا متوافقًا.
...
يمكنك التواصل مع فريق دعم Aspose من خلال موقعه على الويب. إنهم يوفرون قنوات دعم مخصصة لمساعدتك في أي استفسارات أو مشكلات قد تواجهها أثناء استخدام منتجاتهم.