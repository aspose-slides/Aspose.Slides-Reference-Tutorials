...
Có, Aspose.Slides cho Java cung cấp chức năng mở rộng để làm việc với các bản trình bày PowerPoint, bao gồm tạo, sửa đổi và chuyển đổi chúng sang nhiều định dạng khác nhau.
