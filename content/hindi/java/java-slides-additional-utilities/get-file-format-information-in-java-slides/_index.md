...
इस ट्यूटोरियल में, हम Aspose.Slides for Java API का उपयोग करके Java स्लाइड्स में फ़ाइल फ़ॉर्मेट जानकारी प्राप्त करने का तरीका जानेंगे। आप दिए गए कोड स्निपेट से आसानी से प्रेजेंटेशन फ़ाइल का फ़ॉर्मेट निर्धारित कर सकते हैं। आइए विवरण में गोता लगाएँ।
