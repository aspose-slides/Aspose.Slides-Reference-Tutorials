...
उपरोक्त कोड में, हमने ऋणात्मक मानों के लिए भरण रंग को उलटने के लिए श्रृंखला निर्धारित की है और उलटे भरण के लिए रंग निर्दिष्ट किया है।
...
इस ट्यूटोरियल में, हमने आपको Aspose.Slides for Java का उपयोग करके Java Slides में चार्ट के लिए इनवर्ट फिल कलर सेट करने का तरीका दिखाया है। यह सुविधा आपको अपने चार्ट में नकारात्मक मानों को एक विशिष्ट रंग से हाइलाइट करने की अनुमति देती है, जिससे आपका डेटा अधिक दृश्यमान रूप से जानकारीपूर्ण बन जाता है।
