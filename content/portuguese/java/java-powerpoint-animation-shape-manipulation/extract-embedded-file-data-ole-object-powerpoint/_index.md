---
title: Extraia dados de arquivo incorporados de objeto OLE no PowerPoint
...
```
 Esta linha inicializa uma nova instância do`Presentation` class, carregando o arquivo de apresentação do PowerPoint especificado.
...
### O Aspose.Slides requer uma licença para uso comercial?
 Sim, é necessária uma licença válida para uso comercial do Aspose.Slides. Você pode obter uma licença do Aspose[local na rede Internet](https://purchase.aspose.com/temporary-license/).
