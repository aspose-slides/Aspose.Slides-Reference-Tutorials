---
title: Centering Text in PowerPoint Slides with Aspose.Slides for .NET
weight: 7700
limit: 
description: Learn how to apply center alignment to text in PowerPoint presentations using Aspose.Slides for .NET, with step-by-step code examples and explanations.
...
3. Add reference to your project:
   After installation, add the following namespace reference to your C# file:
   ```csharp
   using Aspose.Slides;
   using Aspose.Slides.Export;
   ```

4. Get a free temporary license:
   For testing purposes, you can [request a temporary license](https://purchase.aspose.com/temporary-license/) from the Aspose website.
