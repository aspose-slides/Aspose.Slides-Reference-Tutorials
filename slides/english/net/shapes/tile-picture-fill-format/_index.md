---
title: Create Tiled Image Backgrounds in PowerPoint with Aspose.Slides for .NET 
weight: 7700
limit: 
description: Learn how to create PowerPoint presentations with customized tiled image backgrounds using Aspose.Slides for .NET, including scale, offset, and alignment options.
...
3. Add the following using directives to your C# file:
   ```csharp
   using Aspose.Slides;
