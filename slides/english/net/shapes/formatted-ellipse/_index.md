---
title: Creating Elliptical Shapes in PowerPoint with Aspose.Slides for .NET 
weight: 7700
limit: 
description: Learn how to create and format elliptical shapes in PowerPoint presentations using Aspose.Slides for .NET with this complete code example and step-by-step guide.
...
3. License Setup (Optional):
   If you have a license, apply it using:
   ```csharp
