---
title: Creating Gradient Filled Ellipse Shapes in PowerPoint with Aspose.Slides 
weight: 7700
limit: 
description: Learn how to create PowerPoint presentations with gradient-filled ellipse shapes using Aspose.Slides for .NET. Complete code example with step-by-step instructions.
...
1. Install Aspose.Slides for .NET using one of these methods:
   ...
   - Package Manager Console: `Install-Package Aspose.Slides.NET`
