---
title: Creating a Rectangle Shape with Custom Line Formatting in PowerPoint
weight: 7700
limit: 
description: Learn how to create a rectangle shape in PowerPoint with custom line formatting using Aspose.Slides for .NET, including line style, width, and colors.
...
2. Add the necessary namespace to your C# file:
   ```csharp
   using Aspose.Slides;
