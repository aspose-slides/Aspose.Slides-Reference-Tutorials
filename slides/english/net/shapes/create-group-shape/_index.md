...
weight: 7700
limit: 
description: Step-by-step guide to create and manage group shapes in PowerPoint presentations using Aspose.Slides for .NET, with complete code examples.
...
3. Set up a license (optional for production use):
   ```csharp
   // Set license to remove evaluation restrictions
