...
weight: 7700
limit: 
description: Learn how to create a PowerPoint pie chart using Aspose.Slides for .NET with customized data points, labels, and formatting.
...
3. Add Required References  
   In your Visual Studio project, add a reference to the `Aspose.Slides.dll`.

4. Import Namespaces  
   Add the necessary namespaces at the beginning of your code:
   ```csharp
   using Aspose.Slides;
...
5. Apply a License (Optional but Recommended)  
   To avoid evaluation limitations, you can [apply a license](https://purchase.aspose.com/temporary-license/).
