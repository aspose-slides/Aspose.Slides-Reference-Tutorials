---
title: Creating Clustered Column Charts with Aspose.Slides for .NET
weight: 7700
limit: 
description: The Aspose.Slides for .NET API allows developers to create and manipulate PowerPoint presentations without requiring Microsoft PowerPoint.
...
Or add the following reference to your project file:

```xml
<PackageReference Include="Aspose.Slides" Version="23.2.0" />
```
