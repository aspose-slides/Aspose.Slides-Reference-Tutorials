---
title: Adding Images to Table Cells in PowerPoint with Aspose.Slides for .NET 
weight: 7700
limit: 
description: Learn how to add images to table cells in PowerPoint presentations using Aspose.Slides for .NET with this step-by-step code example and tutorial.
...
1. Install Aspose.Slides for .NET using one of these methods:
   ...
   - Add reference to Aspose.Slides.dll directly in your project

2. Add namespace reference in your C# file:
   ```csharp
   using Aspose.Slides;
   using Aspose.Slides.Export;
   ```

3. Download documentation and API reference:
