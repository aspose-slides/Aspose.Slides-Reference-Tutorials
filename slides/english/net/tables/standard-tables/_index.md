---
title: Create Standardized Tables in PowerPoint with Aspose.Slides for .NET 
weight: 7700
limit: 
description: Learn how to create professionally formatted tables in PowerPoint presentations using Aspose.Slides for .NET. This example demonstrates creating tables with custom borders and formatting.
...
3. Add the following namespace to your C# file:
   ```csharp
   using Aspose.Slides;
