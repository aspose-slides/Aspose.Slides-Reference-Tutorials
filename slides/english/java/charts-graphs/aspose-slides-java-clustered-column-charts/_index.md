...
images:
- /java/charts-graphs/aspose-slides-java-clustered-column-charts/og-image.png
keywords:
...
lastmod: '2026-08-27'
og_description: Learn how to create clustered column chart in Java using Aspose.Slides,
  add the chart, set automatic series colors, and save the presentation as PPTX—all
...
og_title: Create clustered column chart in Java with Aspose.Slides
schemas:
- author: Aspose
...
## Why create a clustered column chart with Aspose.Slides?
...
### Feature 1: create clustered column chart
