...
## Etapa 2: crie uma apresentação
 ...
 Agora, vamos criar uma nova apresentação em PowerPoint usando Aspose.Slides. Você pode definir o diretório onde deseja salvar a apresentação usando o`dataDir` variável.
