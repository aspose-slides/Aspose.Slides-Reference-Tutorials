...
# جافا باور بوينت النص وتخصيص الخط
...
## قم بتعيين رقم نقطي مخصص في Java PowerPoint
...
## إضافة مربع نص على الشريحة برمجياً باستخدام Java
...
### [ضبط لغة العرض وشكل النص في Java](./set-presentation-language-shape-text-java/)
