---
title: Java를 사용하여 PowerPoint에서 표준 테이블 만들기
linktitle: Java를 사용하여 PowerPoint에서 표준 테이블 만들기
second_title: Aspose.Slides Java 파워포인트 프로세싱 API
description: Aspose.Slides를 사용하여 Java로 PowerPoint에서 표준 테이블을 만드는 방법을 알아보세요. 원활한 경험을 위해 자세한 단계별 가이드를 따르세요.
weight: 21
...
2.  Java용 Aspose.Slides: 다음에서 Aspose.Slides for Java 라이브러리를 다운로드하세요.[다운로드 페이지](https://releases.aspose.com/slides/java/).
...
2.  Java 라이브러리용 Aspose.Slides 추가: 다음에서 라이브러리를 다운로드하세요.[다운로드 페이지](https://releases.aspose.com/slides/java/) 프로젝트의 빌드 경로에 추가하세요.
## 2단계: 프레젠테이션 초기화
...
### Aspose.Slides for Java 라이선스를 어떻게 구매할 수 있나요?
 다음에서 라이센스를 구입할 수 있습니다.[Aspose 구매 페이지](https://purchase.aspose.com/buy).
