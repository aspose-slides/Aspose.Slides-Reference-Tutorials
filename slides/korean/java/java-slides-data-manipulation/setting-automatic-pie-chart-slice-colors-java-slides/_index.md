---
title: Java 슬라이드에서 자동 원형 차트 조각 색상 설정
...
## 2단계: PowerPoint 프레젠테이션 만들기
 ...
 인스턴스화`Presentation` 새 PowerPoint 프레젠테이션을 만드는 클래스:
...
프레젠테이션의 첫 번째 슬라이드에 액세스하여 기본 데이터가 포함된 차트를 추가하세요.
...
첫 번째 계열의 값을 표시하도록 차트를 설정하고 차트 데이터를 구성합니다.
...
## Java 슬라이드에서 자동 원형 차트 조각 색상을 설정하기 위한 완전한 소스 코드
...
Aspose.Slides for Java를 사용하여 PowerPoint 프레젠테이션에서 원형 차트를 성공적으로 만들고 자동 조각 색상을 갖도록 구성했습니다. 이 단계별 가이드는 이를 달성하는 데 필요한 소스 코드를 제공합니다. 필요에 따라 차트와 프리젠테이션을 추가로 사용자 정의할 수 있습니다.
...
// 필요에 따라 더 많은 색상 수정을 추가하십시오.
```

### 원형 차트에 범례를 어떻게 추가할 수 있나요?

 원형 차트에 범례를 추가하려면`getLegend` 방법을 선택하고 다음과 같이 구성합니다.
...
### 제목 글꼴과 스타일을 변경할 수 있나요?

예, 제목 글꼴과 스타일을 변경할 수 있습니다. 다음 코드를 사용하여 제목 글꼴 및 스타일을 설정합니다.
