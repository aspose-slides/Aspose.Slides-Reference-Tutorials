...
# Dar formato a estilos de unión en PowerPoint
...
A continuación, definimos el ancho de línea y el color de cada rectángulo. Esto ayuda a diferenciar visualmente los estilos de unión.
```java
