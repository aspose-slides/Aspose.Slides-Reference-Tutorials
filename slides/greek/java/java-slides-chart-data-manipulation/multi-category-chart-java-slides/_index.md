...
# Γράφημα πολλών κατηγοριών σε διαφάνειες Java
...
### Πώς μπορώ να αλλάξω τον τύπο του γραφήματος;
 ...
 Για να αλλάξετε τον τύπο γραφήματος, αντικαταστήστε το`ChartType.ClusteredColumn` με τον επιθυμητό τύπο γραφήματος κατά την προσθήκη του γραφήματος στο Βήμα 2.
