...
अब, आइए स्लाइड में एक दीर्घवृत्ताकार आकृति जोड़ें `AddAutoShape` तरीका:
```csharp
...
## निष्कर्ष
बधाई हो! आपने Aspose.Slides for .NET का उपयोग करके प्रेजेंटेशन स्लाइड में एक सरल दीर्घवृत्त आकार सफलतापूर्वक बनाया है। यह ट्यूटोरियल आकृतियों के साथ काम करने, प्रेजेंटेशन सेट अप करने और संशोधित फ़ाइलों को सहेजने की मूलभूत समझ प्रदान करता है।
---
