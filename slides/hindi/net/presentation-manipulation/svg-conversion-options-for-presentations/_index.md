...
स्केलेबल वेक्टर ग्राफ़िक्स (SVG) एक XML-आधारित वेक्टर इमेज फ़ॉर्मेट है जो आपको ऐसे ग्राफ़िक्स बनाने की अनुमति देता है जिन्हें गुणवत्ता खोए बिना स्केल किया जा सकता है। SVG विशेष रूप से तब उपयोगी होता है जब आपको विभिन्न डिवाइस और स्क्रीन साइज़ पर ग्राफ़िक्स प्रदर्शित करने की आवश्यकता होती है। Aspose.Slides for .NET प्रेजेंटेशन शेप को SVG में बदलने के लिए व्यापक सहायता प्रदान करता है, जो इसे डेवलपर्स के लिए एक आवश्यक टूल बनाता है।
...
- **फ्रेम आकार का उपयोग करें**: यह विकल्प रेंडरिंग क्षेत्र में फ़्रेम को शामिल करता है। इसे इस पर सेट करें `true` फ्रेम को शामिल करने के लिए.
- **फ़्रेम रोटेशन का उपयोग करें**: रेंडरिंग करते समय आकृति के घुमाव को बाहर रखता है। इसे इस पर सेट करें `false` रोटेशन को बाहर करने के लिए.
