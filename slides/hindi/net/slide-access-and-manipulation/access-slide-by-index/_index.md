...
2. प्रतिस्थापित करें `slideIndex` उस स्लाइड की वांछित अनुक्रमिक अनुक्रमणिका के साथ जिसे आप एक्सेस करना चाहते हैं।
...
Aspose.Slides for .NET में कई तरह की कार्यक्षमताएं उपलब्ध हैं, जिसमें स्क्रैच से प्रेजेंटेशन बनाना, स्लाइड्स में बदलाव करना, आकृतियाँ और छवियाँ जोड़ना, फ़ॉर्मेटिंग लागू करना और बहुत कुछ शामिल है। आप यहाँ देख सकते हैं [प्रलेखन](https://reference.aspose.com/slides/net/) विस्तृत जानकारी के लिए.
