...
# जावा स्लाइड्स में XAML में कनवर्ट करें
...
हां, Aspose.Slides पीडीएफ, HTML, इमेज और अन्य सहित कई तरह के आउटपुट फॉर्मेट का समर्थन करता है। आप API डॉक्यूमेंटेशन में इन विकल्पों को देख सकते हैं।
