...
# जावा स्लाइड्स में नोट को TIFF में बदलें


## जावा स्लाइड्स में नोट को TIFF में बदलने का परिचय

इस ट्यूटोरियल में, हम दिखाएंगे कि स्पीकर नोट्स के साथ PowerPoint प्रेजेंटेशन को Aspose.Slides for Java का उपयोग करके TIFF प्रारूप में कैसे परिवर्तित किया जाए। यह लाइब्रेरी प्रोग्रामेटिक रूप से PowerPoint फ़ाइलों के साथ काम करने के लिए शक्तिशाली सुविधाएँ प्रदान करती है।
...
के अंदर `try` ब्लॉक, का उपयोग करें `pres.save` स्पीकर नोट्स के साथ प्रेजेंटेशन को TIFF फ़ाइल में सहेजने की विधि। `SaveFormat.Tiff` पैरामीटर आउटपुट स्वरूप निर्दिष्ट करता है.
...
यदि आपकी प्रस्तुति में नोट्स नहीं हैं, तो रूपांतरण प्रक्रिया फिर भी काम करेगी, और आपको नोट्स के बिना स्लाइडों की TIFF छवि प्राप्त होगी।
