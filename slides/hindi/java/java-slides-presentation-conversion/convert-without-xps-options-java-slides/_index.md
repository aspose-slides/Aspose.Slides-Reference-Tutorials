...
# जावा स्लाइड्स में XPS विकल्प के बिना कनवर्ट करें
...
पावरपॉइंट प्रेजेंटेशन को परिवर्तित करते समय XPS विकल्प निर्दिष्ट करने के लिए, आप इसका उपयोग कर सकते हैं `XpsOptions` क्लास और छवि संपीड़न और फ़ॉन्ट एम्बेडिंग जैसे विभिन्न गुण सेट करें। यदि आपके पास XPS रूपांतरण के लिए विशिष्ट आवश्यकताएँ हैं, तो देखें [Aspose.Slides for Java दस्तावेज़](https://docs.aspose.com/slides/java/) अधिक जानकारी के लिए.
