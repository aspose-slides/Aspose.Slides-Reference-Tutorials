...
```
The `getGeometryPaths` विधि आकृति से जुड़े पथों की एक सरणी लौटाती है। चूँकि हम एक सरल आकृति के साथ काम कर रहे हैं, इसलिए हम पहले पथ तक सीधे पहुँच सकते हैं।
...
```
The `lineTo` विधि ज्यामिति पथ में एक रेखाखंड जोड़ती है। पैरामीटर रेखा के अंत बिंदु और खंड के प्रकार को निर्दिष्ट करते हैं।
