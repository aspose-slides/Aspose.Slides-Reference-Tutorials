...
# PowerPoint में OLE ऑब्जेक्ट फ़्रेम जोड़ें
...
2. Aspose.Slides for Java: वेबसाइट से Aspose.Slides for Java डाउनलोड और इंस्टॉल करें [यहाँ](https://releases.aspose.com/slides/java/).
...
आप जिस PowerPoint फ़ाइल पर काम कर रहे हैं, उसका प्रतिनिधित्व करने के लिए एक प्रेजेंटेशन ऑब्जेक्ट बनाएँ:
```java
