...
अब, आइए PowerPoint प्रस्तुतियों में फ़ॉन्ट फ़ोल्डर्स को पुनः प्राप्त करें। इन फ़ोल्डर्स में फ़ॉन्ट के साथ जोड़ी गई दोनों निर्देशिकाएँ शामिल हैं। `LoadExternalFonts` विधि और सिस्टम फ़ॉन्ट फ़ोल्डर्स.
```java
...
आप Aspose.Slides फ़ोरम पर जा सकते हैं [यहाँ](https://forum.aspose.com/c/slides/11) समुदाय या Aspose सहायता टीम से सहायता प्राप्त करने के लिए।
