...
इस ट्यूटोरियल में, हमने Aspose.Slides for Java API का उपयोग करके Java स्लाइड्स में लेआउट फ़ॉर्मेट तक पहुँचने और उसमें हेरफेर करने का तरीका खोजा है। PowerPoint प्रस्तुतियों में लेआउट स्लाइड्स के भीतर आकृतियों और रेखाओं की उपस्थिति को नियंत्रित करने के लिए लेआउट फ़ॉर्मेट आवश्यक हैं।
