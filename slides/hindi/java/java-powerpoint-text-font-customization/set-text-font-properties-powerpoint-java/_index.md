...
के बजाय `SolidFillColor`, उपयोग `GradientFillColया` or `PatternedFillColor` इसलिए।
### क्या Aspose.Slides पावरपॉइंट टेम्पलेट्स (.potx) के साथ संगत है?
हां, आप पावरपॉइंट टेम्पलेट्स के साथ काम करने के लिए Aspose.Slides का उपयोग कर सकते हैं।
