...
"linktitle": "किसी अन्य प्रस्तुति के अंत में स्लाइड को विशिष्ट स्थान पर क्लोन करें"
"second_title": "Aspose.Slides जावा पावरपॉइंट प्रोसेसिंग एपीआई"
"title": "किसी अन्य प्रस्तुति के अंत में स्लाइड को विशिष्ट स्थान पर क्लोन करें"
...
# किसी अन्य प्रस्तुति के अंत में स्लाइड को विशिष्ट स्थान पर क्लोन करें
...
1. **स्लाइड संग्रह तक पहुंचें:** गंतव्य प्रस्तुति में स्लाइडों का संग्रह पुनः प्राप्त करें.
2. **स्लाइड को क्लोन करें:** क्लोन की गई स्लाइड को गंतव्य प्रस्तुति में वांछित स्थान पर डालें।
```java
...
Aspose.Slides for Java एक निःशुल्क परीक्षण प्रदान करता है। पूर्ण सुविधाओं के लिए, आपको लाइसेंस खरीदना होगा। [Aspose खरीद](https://purchase.aspose.com/buy) अधिक जानकारी के लिए.
...
बिल्कुल। क्लोनिंग के बाद, आप अपनी आवश्यकताओं के अनुरूप Aspose.Slides for Java के व्यापक API का उपयोग करके स्लाइड्स में हेरफेर कर सकते हैं।
