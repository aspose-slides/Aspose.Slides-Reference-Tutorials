...
The `majorUnit` और `minorUnit` मान क्रमशः क्षैतिज अक्ष पर प्रमुख और लघु इकाइयों का प्रतिनिधित्व करते हैं।
...
आप यहां पर विस्तृत दस्तावेज और अतिरिक्त संसाधन पा सकते हैं [Aspose.Slides for Java दस्तावेज़](https://reference.aspose.com/slides/java/) वेबसाइट।
