...
```
 Identifizieren Sie, ob es sich bei der Form um eine AutoForm oder einen Verbinder handelt, und passen Sie die Winkel der Verbinderlinien mit den bereitgestellten`getDirection` Methode.
