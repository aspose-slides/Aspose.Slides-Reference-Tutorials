---
"description": "学习如何使用 Aspose.Slides for Java 在 Java PowerPoint 演示文稿中创建带有自动切片颜色的动态饼图。提供包含源代码的分步指南。"
...
## Java Slides 中饼图切片颜色自动设置简介

在本教程中，我们将探索如何使用 Aspose.Slides for Java 在 PowerPoint 演示文稿中创建饼图，并设置饼图的自动切片颜色。我们将提供分步指导以及源代码。
...
您已成功使用 Aspose.Slides for Java 在 PowerPoint 演示文稿中创建饼图，并将其配置为自动显示切片颜色。本分步指南为您提供了实现此操作所需的源代码。您可以根据需要进一步自定义图表和演示文稿。

## 常见问题解答

### 如何自定义饼图中各个切片的颜色？

要自定义饼图中各个切片的颜色，您可以使用 `getAutomaticSeriesColors` 方法检索默认配色方案，然后根据需要修改颜色。以下是示例：
...
要向饼图添加图例，您可以使用 `getLegend` 方法并按如下方式配置：
