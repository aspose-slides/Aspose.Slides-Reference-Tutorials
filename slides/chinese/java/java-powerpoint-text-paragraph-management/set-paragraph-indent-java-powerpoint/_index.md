...
description: 了解如何使用 Aspose.Slides for Java 以编程方式设置 PowerPoint 幻灯片中的段落缩进。轻松增强您的演示文稿格式。
weight: 16
...
- 下载了 Aspose.Slides for Java 库。您可以从[这里](https://releases.aspose.com/slides/java/).
- 对 Java 编程语言有基本的了解。
## 导入包
